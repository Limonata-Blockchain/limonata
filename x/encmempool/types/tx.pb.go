...
type MsgSubmitEncrypted struct {
	...
	// pok is a Schnorr proof of knowledge of r (A = r*G) bound to the submitter + ciphertext.
	// It makes A non-replayable: no second ciphertext can carry another party's A, closing the
	// same-A decryption-secret-sharing break. 64 bytes (C||Z); see x/encmempool/dkg.EncKeyPoK.
	Pok []byte `protobuf:"bytes,5,opt,name=pok,proto3" json:"pok,omitempty"`
}
...
func (m *MsgSubmitEncrypted) GetPok() []byte {
	if m != nil {
		return m.Pok
	}
	return nil
...
// MsgUpdateParams atomically REPLACES the x/encmempool params. Gov-gated: only the
// x/gov module account (authority) may call it.
//
// params carries the JSON encoding of the module's Params struct — the module stores
// params as JSON-in-store (not proto), so the whole struct is passed opaquely and
// re-decoded on chain. Before it is applied the handler runs the SAME Params.Validate
// used at genesis (bounds DecryptDelay / thresholds / DKG windows, and requires a
// well-formed member/keyper set whenever DkgEnabled/EncEnabled are true), so an update
// can NEVER install a config that would strand EncTx state or panic BeginBlock/EndBlock.
//
// This is the on-chain KILL-SWITCH: it lets governance toggle DkgEnabled / EncEnabled
// (and the safety-bounded DKG params) so that ACTIVATING the dormant DKG is reversible
// by a vote rather than a one-way door needing another coordinated upgrade.
type MsgUpdateParams struct {
	// authority must be the x/gov module account.
	Authority string `protobuf:"bytes,1,opt,name=authority,proto3" json:"authority,omitempty"`
	// params is the JSON-encoded replacement Params (see x/encmempool/types.Params).
...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec253a7da7cb1f1f, []int{13}
}
...
func (m *MsgUpdateParams) GetParams() []byte {
	if m != nil {
		return m.Params
	}
	return nil
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ec253a7da7cb1f1f, []int{14}
}
...
func init() {
	...
	proto.RegisterType((*MsgUpdateParams)(nil), "cosmos.evm.encmempool.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "cosmos.evm.encmempool.v1.MsgUpdateParamsResponse")
}
...
var fileDescriptor_ec253a7da7cb1f1f = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	// UpdateParams atomically replaces the x/encmempool params (the governance
	// KILL-SWITCH). Gov-gated: only the x/gov module account (authority) may call
	// it. This is what makes activating the encrypted path / validator DKG
	// REVERSIBLE — a bad activation of EncEnabled or DkgEnabled can be toggled back
	// OFF by a vote, with no coordinated chain upgrade.
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/cosmos.evm.encmempool.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/cosmos.evm.encmempool.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (m *MsgSubmitEncrypted) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Pok) > 0 {
		i -= len(m.Pok)
		copy(dAtA[i:], m.Pok)
		i = encodeVarintTx(dAtA, i, uint64(len(m.Pok)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Body) > 0 {
...
func (m *MsgSubmitEncrypted) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Pok", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Pok = append(m.Pok[:0], dAtA[iNdEx:postIndex]...)
			if m.Pok == nil {
				m.Pok = []byte{}
			}
			iNdEx = postIndex
