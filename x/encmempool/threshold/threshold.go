// Package threshold is a threshold-ElGamal (hash-DH) encryption scheme
...
//
// On Limonata the threshold key is generated by the transparent validator DKG (package
// dkg): validators jointly produce it on-chain with no trusted dealer, and each share
// carries a Feldman-commitment proof of correctness. Setup() (a trusted Shamir setup)
// is retained only for tests and the legacy path.
package threshold
